...
function(compile_slang_file)
    set(options DEBUG)
    set(oneValueArgs SOURCE_FILE DST)
    ...
    list(APPEND _SLANG_COMMANDS
         COMMAND ${CMAKE_COMMAND} -E echo ${Slang_SLANGC_EXECUTABLE} ${_SLANG_FLAGS} ${COMPILE_SOURCE_FILE}  
         COMMAND ${Slang_SLANGC_EXECUTABLE} ${_SLANG_FLAGS} ${COMPILE_SOURCE_FILE}
    )
